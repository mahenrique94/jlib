...
document.addEventListener('DOMContentLoaded', function(event) {
	...
	let patterns = [
		...
		{name : 'data', pattern : '^(([0][1-9]|[1][\\d]|[2][\\d]|[3][0-1])\\/([0][1-9]|[1][0-2])\\/([19]{2}[\\d]{2}|[20]{2}[\\d]{2}))$', message : 'O campo deve preenchido com uma data no formato: DD/MM/AAAA onde o ano deve ser maior que 1900'},
		...
		{name : 'tipoCNH', pattern : "^([ABCDE]*)$", message : "O campo deve ser preenchido com letras referente a carta de habilitacao."},
